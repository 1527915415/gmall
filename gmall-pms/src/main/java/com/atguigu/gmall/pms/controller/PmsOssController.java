...
public class PmsOssController {
    ...
    String accessId = "LTAI4G1K1ZGA7euw3HHGnkgw"; // 请填写您的AccessKeyId。
    String accessKey = "mGJuSlZxVkRi1AiEgWGM5LRdwmdl98"; // 请填写您的AccessKeySecret。
    String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
    String bucket = "guli-0522-123"; // 请填写您的 bucketname 。
